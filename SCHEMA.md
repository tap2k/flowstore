...
Canonical behavioral spec schema for conversational agents authored in flowstore. The flowstore editor (this repo, `flowstore`) is the primary producer and home of the testing surface. The Python runner ([`../flowstore-runner/`](../flowstore-runner/)) is the canonical native execution consumer.
...
4. Notify affected consumers ([`../flowstore-runner/`](../flowstore-runner/) and any other repos consuming the compiled artifact) when the change affects them.
