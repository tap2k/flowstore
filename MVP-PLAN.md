...
- **Deep graph validation** — variable-reference integrity, `interrupt.scope` members exist, `exit_path.assigns` target validity. Two concrete checks surfaced by runner live-testing 2026-04-30:
