...
- [MVP-PLAN.md](./MVP-PLAN.md) — organizing vision and staged plan to the uxflows Browser MVP (Nov 2026).
- [SCHEMA.md](./SCHEMA.md) — authoritative spec data model.
- [FILE-MODEL.md](./FILE-MODEL.md) — how a uxflows project decomposes into files on disk.
...
- [docs/testing-from-scripts.md](./docs/testing-from-scripts.md) — bring-your-own-script testing path; `uxflows-compile` CLI + file shapes engineers need to know.
