...
export function ComparePage() {
  ...
  const BROWSER_REPORT_OPTS = {
    ...
    footer:
      'Do you want to run studies like this on your own prompts and agents? Try out the tool — <a href="https://flowstore.org/compare">flowstore.org/compare</a>. Free, open source, runs in your browser; your prompt never leaves your machine.',
  };
