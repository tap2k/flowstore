...
export const BUILT_IN_MODELS: ResolvedModelsConfig = {
  models: {
    ...
    "qwen3.7-max":              { name: "Qwen 3.7 Max", endpoint: "openrouter", model_id: "qwen/qwen3.7-max" },
    ...
    "qwen3-next-80b-a3b":       { name: "Qwen 3 Next 80B (free)", endpoint: "openrouter", model_id: "qwen/qwen3-next-80b-a3b-instruct:free" },
